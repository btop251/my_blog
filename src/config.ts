...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://btop251.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-11-23", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bangumi: {
		userId: "1181997", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/btop251",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/1868938112",
					external: true,
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "Welcome to my blog! 俺是ctf菜鸟，ai晓汁.", // 公告内容
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to btop251_blog!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
